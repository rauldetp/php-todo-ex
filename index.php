...
>>>>>>> f07b575 (I think that you wrote it wrong : select query added instead of update, I just added the update query :))
...
if (isset($_POST['action'])) {
  switch($_POST['action']) {
    ...
    case 'delete':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $deleteQuery = 'DELETE FROM todo WHERE id = ' . (int)$id; // IMPLEMENT ME
